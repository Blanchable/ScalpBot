...
class ModeSettings:
    ...
    target_activation_seconds: int = 1
    stop_activation_seconds: int = 3
    min_hold_seconds: int = 1
    exit_confirm_polls: int = 2
    exit_confirm_polls_target: int = 1
    exit_confirm_polls_stop: int = 2
    stop_buffer_beyond_spread_cents: int = 0
    ...
    require_signal_revalidation_on_requote: bool = True
    ...
    neutral_reset_seconds_after_loss: int = 10
    adverse_fill_guard_seconds: int = 3
    adverse_fill_max_loss_cents: int = 2
    enable_trailing_winners: bool = True
    breakeven_trigger_cents: int = 2
    breakeven_lock_cents: int = 1
    trail_arm_cents: int = 3
    trail_distance_cents: int = 2
    hard_take_profit_cents: int = 8
